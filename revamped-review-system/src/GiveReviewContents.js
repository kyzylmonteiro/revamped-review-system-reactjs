      ...
      <Tabs selectedIndex={this.state.tabIndex} onSelect={tabIndex => this.setState({ tabIndex })}>
        ...
        <TabPanel>
          ...
          <div id='halfSec-right'>
            ...
            <div className="rating-stars">
              <h5><center>Rate Quality: {rating}</center></h5>
            ...
            <div id='halfSec-right-bottom'>
              <textarea id="reviewTextarea" placeholder="Please write an honest review to help out a fellow customer."></textarea>
            </div>
          </div>
        </TabPanel>
        ...
        <TabPanel>
          ...
          <div id='halfSec-right'>
            ...
            <div id='halfSec-right-top'>
            <div className="rating-stars">
              <h5><center>Rate Packaging: {rating}</center></h5>
            <div id="ratingContainer">
            <StarRatingComponent
              name="rate1"
              starCount={5}
        ...
        <TabPanel>
          ...
          <div id='halfSec-right'>
            ...
            <div id='halfSec-right-top'>
            <div className="rating-stars">
              <h5><center>Rate Delivery: {rating}</center></h5>
            <div id="ratingContainer">
            <StarRatingComponent
              name="rate1"
              starCount={5}
